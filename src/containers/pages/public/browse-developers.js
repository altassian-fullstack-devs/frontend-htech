...
import { Layout, Collapse, Typography, List, Avatar, Row, Col } from 'antd'
          ...
          <List
            ...
            renderItem={item => (
              <List.Item className='list-item-developer'>
                {/* <List.Item.Meta
                  avatar={<Avatar src="http://gogs.hope.com/avatars/10?s=287" />}
                  title={<Link to='/profile'>{item.title}</Link>}
