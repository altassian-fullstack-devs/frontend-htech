  ...
  return (
    <div className="left-block">
      <span>
        ...
        <p>The delivered functionality and enhanced system productivity ensured a smooth experience for end users that ultimately resulted in a more competitive market stance.</p>
        <br/> <br/>
        <p></p>
      </span>
