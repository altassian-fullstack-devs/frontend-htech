        ...
        <div> 
          <div className="blog-comments">
              ...
              <div id="comment-1" className="comment clearfix">
                <img src="img/comments-1.jpg" className="comment-img  float-left" alt=""/>
              ...
              <div id="comment-2" className="comment clearfix">
                <img src="img/comments-2.jpg" className="comment-img  float-left" alt=""/>
                ...
                <div id="comment-reply-1" className="comment comment-reply clearfix">
                  <img src="img/comments-3.jpg" className="comment-img  float-left" alt=""/>
                  ...
                  <div id="comment-reply-2" className="comment comment-reply clearfix">
                    <img src="img/comments-4.jpg" className="comment-img  float-left" alt=""/>
                    <h5><a href="">Sianna Ramsay</a> <a href="#" className="reply"><i className="icofont-reply"></i> Reply</a></h5>
                    <time datetime="2020-01-01">01 Jan, 2020</time>
                    <p>
              ...
              <div id="comment-3" className="comment clearfix">
                <img src="img/comments-5.jpg" className="comment-img  float-left" alt=""/>
              ...
              <div id="comment-4" className="comment clearfix">
                <img src="img/comments-6.jpg" className="comment-img  float-left" alt="" />
